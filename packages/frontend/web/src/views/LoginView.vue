      ...
      <div class="card-body p-8">
        ...
        <div class="space-y-6">
          <div class="form-control">
            <label class="label">
              <span class="label-text text-base-content font-medium">{{ tx('username') }}</span>
            </label>
            <input
              v-model="username"
              type="text"
          ...
          <div class="form-control">
            <label class="label">
              <span class="label-text text-base-content font-medium">{{ tx('password') }}</span>
            </label>
            <div class="relative">
              <input
                v-model="password"
